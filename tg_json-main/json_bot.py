...
bot = TeleBot(token='5801008792:AAEoUqC8FbulPRI6RLGGkeMN65AscDmj0wg', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='# подключение библиотеки telebot
# В google colab добавить: !pip install pyTelegramBotAPI
# для установки необходимо в файл requirements.text добавить строку
# 'PyTelegramBotApi'
from telebot import TeleBot, types
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id, # id чата, в который необходимо направить сообщение
        text='Привет! Я умею проверять JSON и форматировать его в красивый текст\nВведи JSON в виде строки:', # текст сообщения
        text='Пример ввода:{"name": "Smith", "nickname": "smit", "id": 475, "age": 25}',
    )
